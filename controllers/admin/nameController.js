...
class NameController extends BaseController {
  ...
  async get(req, res, next) {
    try {
      ...
      const names = await Name.find(filters).populate('adminId', 'name').populate('religionId', 'name').select('name origion status createdAt').skip(skip).limit(limit);
  ...
  async info(req, res, next) {
    try {
      ...
      const name = await Name.findOne(filters).populate('adminId', 'name').populate('religionId', 'name').populate('categoryId', 'name');
